...
(function() {
  ...
  SwaggerResource = (function() {
    ...
    function SwaggerResource(resourceObj, api) {
      ...
      produces = [];
      consumes = [];
      this.path = this.api.resourcePath != null ? this.api.resourcePath : resourceObj.path || resourceObj.name;
      ...
      this.models = {};
      this.rawModels = {};
      if ((resourceObj.apis != null) && ((this.api.resourcePath != null) || (resourceObj.name != null))) {
  ...
  SwaggerOperation = (function() {
    function SwaggerOperation(nickname, path, method, parameters, summary, notes, type, responseMessages, resource, consumes, produces, authorizations) {
      var parameter, response, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      ...
      _ref1 = this.responseMessages;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        response = _ref1[_i];
        if (!!response.responseModel) {
          response.signature = this.getSignature(response.responseModel, this.resource.models);
          response.sampleJSON = this.getSampleJSON(response.responseModel, this.resource.models);
        }
      }
